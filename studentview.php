...
class cstudent_view extends cstudent {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["stud_id"] <> "") {
			$this->RecKey["stud_id"] = $_GET["stud_id"];
			$KeyUrl .= "&amp;stud_id=" . urlencode($this->RecKey["stud_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["stud_id"] <> "") {
				...
				$this->RecKey["stud_id"] = $this->stud_id->QueryStringValue;
			} elseif (@$_POST["stud_id"] <> "") {
				$this->stud_id->setFormValue($_POST["stud_id"]);
				$this->RecKey["stud_id"] = $this->stud_id->FormValue;
			} else {
...
<?php if ($student->stud_id->Visible) { // stud_id ?>
	<tr id="r_stud_id">
		<td><span id="elh_student_stud_id"><?php echo $student->stud_id->FldCaption() ?></span></td>
...
<?php echo $student->stud_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->IMSA_id->Visible) { // IMSA_id ?>
	<tr id="r_IMSA_id">
		<td><span id="elh_student_IMSA_id"><?php echo $student->IMSA_id->FldCaption() ?></span></td>
...
<?php echo $student->IMSA_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_student_name"><?php echo $student->name->FldCaption() ?></span></td>
...
<?php if ($student->grade->Visible) { // grade ?>
	<tr id="r_grade">
		<td><span id="elh_student_grade"><?php echo $student->grade->FldCaption() ?></span></td>
...
<?php echo $student->grade->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($student->password->Visible) { // password ?>
	<tr id="r_password">
		<td><span id="elh_student_password"><?php echo $student->password->FldCaption() ?></span></td>
...
<?php if ($student->owed->Visible) { // owed ?>
	<tr id="r_owed">
		<td><span id="elh_student_owed"><?php echo $student->owed->FldCaption() ?></span></td>
		<td data-name="owed"<?php echo $student->owed->CellAttributes() ?>>
<span id="el_student_owed">
<span<?php echo $student->owed->ViewAttributes() ?>>
<?php echo $student->owed->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->parent_email->Visible) { // parent_email ?>
	<tr id="r_parent_email">
		<td><span id="elh_student_parent_email"><?php echo $student->parent_email->FldCaption() ?></span></td>
...
<?php echo $student->parent_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->parent_number->Visible) { // parent_number ?>
	<tr id="r_parent_number">
		<td><span id="elh_student_parent_number"><?php echo $student->parent_number->FldCaption() ?></span></td>
...
<?php echo $student->parent_number->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
