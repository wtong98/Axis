...
class cteachers_edit extends cteachers {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("teacherslist.php"); // Invalid key, return to list
		}
...
fteachersedit.ValidateRequired = true;
<?php } else { ?>
fteachersedit.ValidateRequired = false; 
<?php } ?>
...
<?php if ($teachers->CurrentAction == "F") { // Confirm page ?>
...
<?php if ($teachers->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_teachers_id" for="x_id" class="col-sm-2 control-label ewLabel"><?php echo $teachers->id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $teachers->id->CellAttributes() ?>>
...
<input type="hidden" data-table="teachers" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($teachers->id->FormValue) ?>">
<?php } ?>
<?php echo $teachers->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teachers->privilege->Visible) { // privilege ?>
	<div id="r_privilege" class="form-group">
		<label id="elh_teachers_privilege" for="x_privilege" class="col-sm-2 control-label ewLabel"><?php echo $teachers->privilege->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $teachers->privilege->CellAttributes() ?>>
<?php if ($teachers->CurrentAction <> "F") { ?>
<span id="el_teachers_privilege">
<input type="text" data-table="teachers" data-field="x_privilege" name="x_privilege" id="x_privilege" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($teachers->privilege->getPlaceHolder()) ?>" value="<?php echo $teachers->privilege->EditValue ?>"<?php echo $teachers->privilege->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el_teachers_privilege">
<span<?php echo $teachers->privilege->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $teachers->privilege->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="teachers" data-field="x_privilege" name="x_privilege" id="x_privilege" value="<?php echo ew_HtmlEncode($teachers->privilege->FormValue) ?>">
<?php } ?>
<?php echo $teachers->privilege->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teachers->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_teachers__email" for="x__email" class="col-sm-2 control-label ewLabel"><?php echo $teachers->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $teachers->_email->CellAttributes() ?>>
<?php if ($teachers->CurrentAction <> "F") { ?>
<span id="el_teachers__email">
<input type="text" data-table="teachers" data-field="x__email" name="x__email" id="x__email" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($teachers->_email->getPlaceHolder()) ?>" value="<?php echo $teachers->_email->EditValue ?>"<?php echo $teachers->_email->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el_teachers__email">
<span<?php echo $teachers->_email->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $teachers->_email->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="teachers" data-field="x__email" name="x__email" id="x__email" value="<?php echo ew_HtmlEncode($teachers->_email->FormValue) ?>">
<?php } ?>
<?php echo $teachers->_email->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teachers->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_teachers_name" for="x_name" class="col-sm-2 control-label ewLabel"><?php echo $teachers->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $teachers->name->CellAttributes() ?>>
<?php if ($teachers->CurrentAction <> "F") { ?>
<span id="el_teachers_name">
<input type="text" data-table="teachers" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($teachers->name->getPlaceHolder()) ?>" value="<?php echo $teachers->name->EditValue ?>"<?php echo $teachers->name->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el_teachers_name">
<span<?php echo $teachers->name->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $teachers->name->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="teachers" data-field="x_name" name="x_name" id="x_name" value="<?php echo ew_HtmlEncode($teachers->name->FormValue) ?>">
<?php } ?>
<?php echo $teachers->name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teachers->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_teachers_password" for="x_password" class="col-sm-2 control-label ewLabel"><?php echo $teachers->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $teachers->password->CellAttributes() ?>>
<?php if ($teachers->CurrentAction <> "F") { ?>
<span id="el_teachers_password">
<input type="text" data-table="teachers" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($teachers->password->getPlaceHolder()) ?>" value="<?php echo $teachers->password->EditValue ?>"<?php echo $teachers->password->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el_teachers_password">
<span<?php echo $teachers->password->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $teachers->password->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="teachers" data-field="x_password" name="x_password" id="x_password" value="<?php echo ew_HtmlEncode($teachers->password->FormValue) ?>">
<?php } ?>
<?php echo $teachers->password->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$teachers_edit->IsModal) { ?>
