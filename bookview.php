...
fbookview.ValidateRequired = true;
<?php } else { ?>
fbookview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fbookview.Lists["x_dept_id"] = {"LinkField":"x_dept_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"department"};
...
<?php if ($book->book_id->Visible) { // book_id ?>
	<tr id="r_book_id">
		<td><span id="elh_book_book_id"><?php echo $book->book_id->FldCaption() ?></span></td>
...
<?php if ($book->IMSA_id->Visible) { // IMSA_id ?>
	<tr id="r_IMSA_id">
		<td><span id="elh_book_IMSA_id"><?php echo $book->IMSA_id->FldCaption() ?></span></td>
...
<?php echo $book->IMSA_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($book->fee->Visible) { // fee ?>
	<tr id="r_fee">
		<td><span id="elh_book_fee"><?php echo $book->fee->FldCaption() ?></span></td>
		<td data-name="fee"<?php echo $book->fee->CellAttributes() ?>>
<span id="el_book_fee">
<span<?php echo $book->fee->ViewAttributes() ?>>
<?php echo $book->fee->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($book->dept_id->Visible) { // dept_id ?>
	<tr id="r_dept_id">
		<td><span id="elh_book_dept_id"><?php echo $book->dept_id->FldCaption() ?></span></td>
...
<?php echo $book->dept_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
