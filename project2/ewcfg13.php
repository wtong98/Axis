...
define("EW_PROJECT_ID", "{8f9e4799-e991-49ac-a0be-7b3f0a30522b}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'b2UieYoyPOwN4qJI', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "karolina", "pass" => "newpass0109", "db" => "testv3", "qs" => "`", "qe" => "`");
