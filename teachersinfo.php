...
class cteachers extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('teachers', 'teachers', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// privilege
		$this->privilege = new cField('teachers', 'teachers', 'x_privilege', 'privilege', '`privilege`', '`privilege`', 200, -1, FALSE, '`privilege`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->privilege->Sortable = TRUE; // Allow sort
		$this->fields['privilege'] = &$this->privilege;

		// email
		$this->_email = new cField('teachers', 'teachers', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->_email->FldDefaultErrMsg = $Language->Phrase("IncorrectEmail");
		$this->fields['email'] = &$this->_email;

		// name
		$this->name = new cField('teachers', 'teachers', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// password
		$this->password = new cField('teachers', 'teachers', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->privilege->EditValue = $this->privilege->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->privilege->Exportable) $Doc->ExportCaption($this->privilege);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->privilege->Exportable) $Doc->ExportField($this->privilege);
