...
class cstudent_list extends cstudent {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->parent_number->AdvancedSearch->ToJSON(), ","); // Field parent_number
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field parent_number
		$this->parent_number->AdvancedSearch->SearchValue = @$filter["x_parent_number"];
		$this->parent_number->AdvancedSearch->SearchOperator = @$filter["z_parent_number"];
		$this->parent_number->AdvancedSearch->SearchCondition = @$filter["v_parent_number"];
		$this->parent_number->AdvancedSearch->SearchValue2 = @$filter["y_parent_number"];
		$this->parent_number->AdvancedSearch->SearchOperator2 = @$filter["w_parent_number"];
		$this->parent_number->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->parent_number, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->parent_number); // parent_number
	...
	function LoadDefaultValues() {
		...
		$this->parent_number->CurrentValue = NULL;
		$this->parent_number->OldValue = $this->parent_number->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// parent_number
		$this->parent_number->SetDbValueDef($rsnew, $this->parent_number->CurrentValue, NULL, FALSE);
...
<?php if ($student->password->Visible) { // password ?>
	<?php if ($student->SortUrl($student->password) == "") { ?>
		<th data-name="password"><div id="elh_student_password" class="student_password"><div class="ewTableHeaderCaption"><?php echo $student->password->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->password) ?>',1);"><div id="elh_student_password" class="student_password">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->password->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($student->password->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->password->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($student->parent_number->Visible) { // parent_number ?>
	<?php if ($student->SortUrl($student->parent_number) == "") { ?>
		<th data-name="parent_number"><div id="elh_student_parent_number" class="student_parent_number"><div class="ewTableHeaderCaption"><?php echo $student->parent_number->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="parent_number"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->parent_number) ?>',1);"><div id="elh_student_parent_number" class="student_parent_number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->parent_number->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($student->parent_number->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->parent_number->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $student_list->RowCnt ?>_student_password" class="form-group student_password">
<input type="text" data-table="student" data-field="x_password" name="x<?php echo $student_list->RowIndex ?>_password" id="x<?php echo $student_list->RowIndex ?>_password" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($student->password->getPlaceHolder()) ?>" value="<?php echo $student->password->EditValue ?>"<?php echo $student->password->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_password" name="o<?php echo $student_list->RowIndex ?>_password" id="o<?php echo $student_list->RowIndex ?>_password" value="<?php echo ew_HtmlEncode($student->password->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($student->owed->Visible) { // owed ?>
		<td data-name="owed">
...
<input type="hidden" data-table="student" data-field="x_parent_email" name="o<?php echo $student_list->RowIndex ?>_parent_email" id="o<?php echo $student_list->RowIndex ?>_parent_email" value="<?php echo ew_HtmlEncode($student->parent_email->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($student->parent_number->Visible) { // parent_number ?>
		<td data-name="parent_number">
<span id="el<?php echo $student_list->RowCnt ?>_student_parent_number" class="form-group student_parent_number">
<input type="text" data-table="student" data-field="x_parent_number" name="x<?php echo $student_list->RowIndex ?>_parent_number" id="x<?php echo $student_list->RowIndex ?>_parent_number" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($student->parent_number->getPlaceHolder()) ?>" value="<?php echo $student->parent_number->EditValue ?>"<?php echo $student->parent_number->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_parent_number" name="o<?php echo $student_list->RowIndex ?>_parent_number" id="o<?php echo $student_list->RowIndex ?>_parent_number" value="<?php echo ew_HtmlEncode($student->parent_number->OldValue) ?>">
</td>
	<?php } ?>
<?php
...
<?php } ?>
<?php if ($student->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_password" class="student_password">
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($student->parent_number->Visible) { // parent_number ?>
		<td data-name="parent_number"<?php echo $student->parent_number->CellAttributes() ?>>
<?php if ($student->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_parent_number" class="form-group student_parent_number">
<input type="text" data-table="student" data-field="x_parent_number" name="x<?php echo $student_list->RowIndex ?>_parent_number" id="x<?php echo $student_list->RowIndex ?>_parent_number" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($student->parent_number->getPlaceHolder()) ?>" value="<?php echo $student->parent_number->EditValue ?>"<?php echo $student->parent_number->EditAttributes() ?>>
</span>
<?php } ?>
<?php if ($student->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_parent_number" class="student_parent_number">
