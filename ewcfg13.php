...
define("EW_RANDOM_KEY", 'ZoLkzQk5HnqlnX8p', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "karolina", "pass" => "newpass0109", "db" => "testv4", "qs" => "`", "qe" => "`");
