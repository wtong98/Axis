...
fteachersview.ValidateRequired = true;
<?php } else { ?>
fteachersview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($teachers->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_teachers_id"><?php echo $teachers->id->FldCaption() ?></span></td>
...
<?php if ($teachers->privilege->Visible) { // privilege ?>
	<tr id="r_privilege">
		<td><span id="elh_teachers_privilege"><?php echo $teachers->privilege->FldCaption() ?></span></td>
...
<?php echo $teachers->privilege->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_teachers__email"><?php echo $teachers->_email->FldCaption() ?></span></td>
...
<?php echo $teachers->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_teachers_name"><?php echo $teachers->name->FldCaption() ?></span></td>
...
<?php echo $teachers->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers->password->Visible) { // password ?>
	<tr id="r_password">
		<td><span id="elh_teachers_password"><?php echo $teachers->password->FldCaption() ?></span></td>
...
<?php echo $teachers->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
