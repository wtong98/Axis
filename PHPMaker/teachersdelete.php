...
fteachersdelete.ValidateRequired = true;
<?php } else { ?>
fteachersdelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($teachers->id->Visible) { // id ?>
		<th><span id="elh_teachers_id" class="teachers_id"><?php echo $teachers->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers->privilege->Visible) { // privilege ?>
		<th><span id="elh_teachers_privilege" class="teachers_privilege"><?php echo $teachers->privilege->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers->_email->Visible) { // email ?>
		<th><span id="elh_teachers__email" class="teachers__email"><?php echo $teachers->_email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers->name->Visible) { // name ?>
		<th><span id="elh_teachers_name" class="teachers_name"><?php echo $teachers->name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers->password->Visible) { // password ?>
		<th><span id="elh_teachers_password" class="teachers_password"><?php echo $teachers->password->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($teachers->privilege->Visible) { // privilege ?>
		<td<?php echo $teachers->privilege->CellAttributes() ?>>
<span id="el<?php echo $teachers_delete->RowCnt ?>_teachers_privilege" class="teachers_privilege">
...
<?php } ?>
<?php if ($teachers->_email->Visible) { // email ?>
		<td<?php echo $teachers->_email->CellAttributes() ?>>
<span id="el<?php echo $teachers_delete->RowCnt ?>_teachers__email" class="teachers__email">
...
<?php } ?>
<?php if ($teachers->name->Visible) { // name ?>
		<td<?php echo $teachers->name->CellAttributes() ?>>
<span id="el<?php echo $teachers_delete->RowCnt ?>_teachers_name" class="teachers_name">
...
<?php } ?>
<?php if ($teachers->password->Visible) { // password ?>
		<td<?php echo $teachers->password->CellAttributes() ?>>
<span id="el<?php echo $teachers_delete->RowCnt ?>_teachers_password" class="teachers_password">
