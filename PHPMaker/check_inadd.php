...
$check_in_add = NULL; // Initialize page object first

class ccheck_in_add extends ccheck_in {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "check_inview.php")
...
// Create page object
if (!isset($check_in_add)) $check_in_add = new ccheck_in_add();

// Page init
$check_in_add->Page_Init();

// Page main
$check_in_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$check_in_add->Page_Render();
?>
...
var CurrentForm = fcheck_inadd = new ew_Form("fcheck_inadd", "add");

// Validate form
fcheck_inadd.Validate = function() {
...
fcheck_inadd.Form_CustomValidate = 
...
fcheck_inadd.ValidateRequired = true;
<?php } else { ?>
fcheck_inadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcheck_inadd.Lists["x_book"] = {"LinkField":"x_IMSA_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","x_IMSA_id","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"book"};
...
<?php } ?>
<?php $check_in_add->ShowPageHeader(); ?>
<?php
$check_in_add->ShowMessage();
?>
<form name="fcheck_inadd" id="fcheck_inadd" class="<?php echo $check_in_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($check_in_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $check_in_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fcheck_inadd.CreateAutoSuggest({"id":"x_book","forceSelect":false});
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $check_in_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
