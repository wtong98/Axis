...
define("EW_PROJECT_ID", "{3a40fa8e-bfb7-4bd3-8e5b-bf1eefd884a7}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'eHffOhykj44zRndh', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "karolina", "pass" => "newpass0109", "db" => "test", "qs" => "`", "qe" => "`");
