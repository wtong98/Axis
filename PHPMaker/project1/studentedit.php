...
<?php if ($student->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_student_id" class="col-sm-2 control-label ewLabel"><?php echo $student->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $student->id->CellAttributes() ?>>
...
<input type="hidden" data-table="student" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($student->id->CurrentValue) ?>">
<?php echo $student->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
