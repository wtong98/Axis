...
<input type="text" data-table="book" data-field="x_dept_id" name="x<?php echo $book_list->RowIndex ?>_dept_id" id="x<?php echo $book_list->RowIndex ?>_dept_id" size="30" placeholder="<?php echo ew_HtmlEncode($book->dept_id->getPlaceHolder()) ?>" value="<?php echo $book->dept_id->EditValue ?>"<?php echo $book->dept_id->EditAttributes() ?>>
</span>
