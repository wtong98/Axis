...
fteachersadd.ValidateRequired = true;
<?php } else { ?>
fteachersadd.ValidateRequired = false; 
<?php } ?>
...
<input type="text" data-table="teachers" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo ew_HtmlEncode($teachers->id->getPlaceHolder()) ?>" value="<?php echo $teachers->id->EditValue ?>"<?php echo $teachers->id->EditAttributes() ?>>
</span>
