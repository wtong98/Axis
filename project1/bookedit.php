...
<?php if ($book->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_book_id" class="col-sm-2 control-label ewLabel"><?php echo $book->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $book->id->CellAttributes() ?>>
<span id="el_book_id">
<span<?php echo $book->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $book->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="book" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($book->id->CurrentValue) ?>">
<?php echo $book->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($book->Cost->Visible) { // Cost ?>
	<div id="r_Cost" class="form-group">
		<label id="elh_book_Cost" for="x_Cost" class="col-sm-2 control-label ewLabel"><?php echo $book->Cost->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
