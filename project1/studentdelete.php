...
<?php if ($student->id->Visible) { // id ?>
		<th><span id="elh_student_id" class="student_id"><?php echo $student->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($student->IMSAid->Visible) { // IMSAid ?>
		<th><span id="elh_student_IMSAid" class="student_IMSAid"><?php echo $student->IMSAid->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($student->id->Visible) { // id ?>
		<td<?php echo $student->id->CellAttributes() ?>>
<span id="el<?php echo $student_delete->RowCnt ?>_student_id" class="student_id">
...
<?php } ?>
<?php if ($student->IMSAid->Visible) { // IMSAid ?>
		<td<?php echo $student->IMSAid->CellAttributes() ?>>
<span id="el<?php echo $student_delete->RowCnt ?>_student_IMSAid" class="student_IMSAid">
