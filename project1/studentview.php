...
<?php if ($student->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_student_id"><?php echo $student->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $student->id->CellAttributes() ?>>
<span id="el_student_id">
<span<?php echo $student->id->ViewAttributes() ?>>
<?php echo $student->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($student->IMSAid->Visible) { // IMSAid ?>
	<tr id="r_IMSAid">
		<td><span id="elh_student_IMSAid"><?php echo $student->IMSAid->FldCaption() ?></span></td>
...
<?php echo $student->IMSAid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
