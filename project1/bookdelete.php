...
<?php if ($book->id->Visible) { // id ?>
		<th><span id="elh_book_id" class="book_id"><?php echo $book->id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($book->id->Visible) { // id ?>
		<td<?php echo $book->id->CellAttributes() ?>>
<span id="el<?php echo $book_delete->RowCnt ?>_book_id" class="book_id">
