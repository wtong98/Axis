...
class cstudent_list extends cstudent {
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_IMSAid") && $objForm->HasValue("o_IMSAid") && $this->IMSAid->CurrentValue <> $this->IMSAid->OldValue)
			return FALSE;
		...
		if ($objForm->HasValue("x__email") && $objForm->HasValue("o__email") && $this->_email->CurrentValue <> $this->_email->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_owed") && $objForm->HasValue("o_owed") && $this->owed->CurrentValue <> $this->owed->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->IMSAid->AdvancedSearch->ToJSON(), ","); // Field IMSAid
	...
	function RestoreFilterList() {
		...
		// Field IMSAid
		$this->IMSAid->AdvancedSearch->SearchValue = @$filter["x_IMSAid"];
		$this->IMSAid->AdvancedSearch->SearchOperator = @$filter["z_IMSAid"];
		$this->IMSAid->AdvancedSearch->SearchCondition = @$filter["v_IMSAid"];
		$this->IMSAid->AdvancedSearch->SearchValue2 = @$filter["y_IMSAid"];
		$this->IMSAid->AdvancedSearch->SearchOperator2 = @$filter["w_IMSAid"];
		$this->IMSAid->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->IMSAid, $arKeywords, $type);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->IMSAid); // IMSAid
	...
	function LoadFormValues() {
		...
		$this->IMSAid->setOldValue($objForm->GetValue("o_IMSAid"));
		...
		$this->owed->setOldValue($objForm->GetValue("o_owed"));
	}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// IMSAid
			$this->IMSAid->SetDbValueDef($rsnew, $this->IMSAid->CurrentValue, "", $this->IMSAid->ReadOnly);
			...
			// owed
			$this->owed->SetDbValueDef($rsnew, $this->owed->CurrentValue, "", $this->owed->ReadOnly);
...
fstudentlist.EmptyRow = function(infix) {
	var fobj = this.Form;
	if (ew_ValueChanged(fobj, infix, "IMSAid", false)) return false;
	...
	if (ew_ValueChanged(fobj, infix, "owed", false)) return false;
	return true;
}
...
?>
<?php if ($student->id->Visible) { // id ?>
	<?php if ($student->SortUrl($student->id) == "") { ?>
		<th data-name="id"><div id="elh_student_id" class="student_id"><div class="ewTableHeaderCaption"><?php echo $student->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->id) ?>',1);"><div id="elh_student_id" class="student_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($student->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($student->IMSAid->Visible) { // IMSAid ?>
	<?php if ($student->SortUrl($student->IMSAid) == "") { ?>
		<th data-name="IMSAid"><div id="elh_student_IMSAid" class="student_IMSAid"><div class="ewTableHeaderCaption"><?php echo $student->IMSAid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="IMSAid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $student->SortUrl($student->IMSAid) ?>',1);"><div id="elh_student_IMSAid" class="student_IMSAid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $student->IMSAid->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($student->IMSAid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($student->IMSAid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
?>
	<?php if ($student->id->Visible) { // id ?>
		<td data-name="id">
<input type="hidden" data-table="student" data-field="x_id" name="o<?php echo $student_list->RowIndex ?>_id" id="o<?php echo $student_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($student->id->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($student->IMSAid->Visible) { // IMSAid ?>
		<td data-name="IMSAid">
<span id="el<?php echo $student_list->RowCnt ?>_student_IMSAid" class="form-group student_IMSAid">
<input type="text" data-table="student" data-field="x_IMSAid" name="x<?php echo $student_list->RowIndex ?>_IMSAid" id="x<?php echo $student_list->RowIndex ?>_IMSAid" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($student->IMSAid->getPlaceHolder()) ?>" value="<?php echo $student->IMSAid->EditValue ?>"<?php echo $student->IMSAid->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_IMSAid" name="o<?php echo $student_list->RowIndex ?>_IMSAid" id="o<?php echo $student_list->RowIndex ?>_IMSAid" value="<?php echo ew_HtmlEncode($student->IMSAid->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($student->Name->Visible) { // Name ?>
		<td data-name="Name">
...
<input type="text" data-table="student" data-field="x_owed" name="x<?php echo $student_list->RowIndex ?>_owed" id="x<?php echo $student_list->RowIndex ?>_owed" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($student->owed->getPlaceHolder()) ?>" value="<?php echo $student->owed->EditValue ?>"<?php echo $student->owed->EditAttributes() ?>>
</span>
...
?>
	<?php if ($student->id->Visible) { // id ?>
		<td data-name="id"<?php echo $student->id->CellAttributes() ?>>
<?php if ($student->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="student" data-field="x_id" name="o<?php echo $student_list->RowIndex ?>_id" id="o<?php echo $student_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($student->id->OldValue) ?>">
<?php } ?>
<?php if ($student->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_id" class="form-group student_id">
<span<?php echo $student->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $student->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="student" data-field="x_id" name="x<?php echo $student_list->RowIndex ?>_id" id="x<?php echo $student_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($student->id->CurrentValue) ?>">
<?php } ?>
<?php if ($student->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_id" class="student_id">
<span<?php echo $student->id->ViewAttributes() ?>>
<?php echo $student->id->ListViewValue() ?></span>
</span>
<?php } ?>
<a id="<?php echo $student_list->PageObjName . "_row_" . $student_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($student->IMSAid->Visible) { // IMSAid ?>
		<td data-name="IMSAid"<?php echo $student->IMSAid->CellAttributes() ?>>
<?php if ($student->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_IMSAid" class="form-group student_IMSAid">
<input type="text" data-table="student" data-field="x_IMSAid" name="x<?php echo $student_list->RowIndex ?>_IMSAid" id="x<?php echo $student_list->RowIndex ?>_IMSAid" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($student->IMSAid->getPlaceHolder()) ?>" value="<?php echo $student->IMSAid->EditValue ?>"<?php echo $student->IMSAid->EditAttributes() ?>>
</span>
...
<?php } ?>
<?php if ($student->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $student_list->RowCnt ?>_student_IMSAid" class="student_IMSAid">
<span<?php echo $student->IMSAid->ViewAttributes() ?>>
<?php echo $student->IMSAid->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="student" data-field="x_id" name="o<?php echo $student_list->RowIndex ?>_id" id="o<?php echo $student_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($student->id->OldValue) ?>">
	...
	<?php if ($student->IMSAid->Visible) { // IMSAid ?>
		<td data-name="IMSAid">
<span id="el$rowindex$_student_IMSAid" class="form-group student_IMSAid">
<input type="text" data-table="student" data-field="x_IMSAid" name="x<?php echo $student_list->RowIndex ?>_IMSAid" id="x<?php echo $student_list->RowIndex ?>_IMSAid" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($student->IMSAid->getPlaceHolder()) ?>" value="<?php echo $student->IMSAid->EditValue ?>"<?php echo $student->IMSAid->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_IMSAid" name="o<?php echo $student_list->RowIndex ?>_IMSAid" id="o<?php echo $student_list->RowIndex ?>_IMSAid" value="<?php echo ew_HtmlEncode($student->IMSAid->OldValue) ?>">
</td>
	...
	<?php if ($student->Name->Visible) { // Name ?>
		<td data-name="Name">
<span id="el$rowindex$_student_Name" class="form-group student_Name">
<input type="text" data-table="student" data-field="x_Name" name="x<?php echo $student_list->RowIndex ?>_Name" id="x<?php echo $student_list->RowIndex ?>_Name" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($student->Name->getPlaceHolder()) ?>" value="<?php echo $student->Name->EditValue ?>"<?php echo $student->Name->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_Name" name="o<?php echo $student_list->RowIndex ?>_Name" id="o<?php echo $student_list->RowIndex ?>_Name" value="<?php echo ew_HtmlEncode($student->Name->OldValue) ?>">
</td>
	...
	<?php if ($student->Grade->Visible) { // Grade ?>
		<td data-name="Grade">
<span id="el$rowindex$_student_Grade" class="form-group student_Grade">
<input type="text" data-table="student" data-field="x_Grade" name="x<?php echo $student_list->RowIndex ?>_Grade" id="x<?php echo $student_list->RowIndex ?>_Grade" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($student->Grade->getPlaceHolder()) ?>" value="<?php echo $student->Grade->EditValue ?>"<?php echo $student->Grade->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_Grade" name="o<?php echo $student_list->RowIndex ?>_Grade" id="o<?php echo $student_list->RowIndex ?>_Grade" value="<?php echo ew_HtmlEncode($student->Grade->OldValue) ?>">
</td>
...
<input type="hidden" data-table="student" data-field="x__email" name="o<?php echo $student_list->RowIndex ?>__email" id="o<?php echo $student_list->RowIndex ?>__email" value="<?php echo ew_HtmlEncode($student->_email->OldValue) ?>">
	...
	<?php if ($student->owed->Visible) { // owed ?>
		<td data-name="owed">
<span id="el$rowindex$_student_owed" class="form-group student_owed">
<input type="text" data-table="student" data-field="x_owed" name="x<?php echo $student_list->RowIndex ?>_owed" id="x<?php echo $student_list->RowIndex ?>_owed" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($student->owed->getPlaceHolder()) ?>" value="<?php echo $student->owed->EditValue ?>"<?php echo $student->owed->EditAttributes() ?>>
</span>
<input type="hidden" data-table="student" data-field="x_owed" name="o<?php echo $student_list->RowIndex ?>_owed" id="o<?php echo $student_list->RowIndex ?>_owed" value="<?php echo ew_HtmlEncode($student->owed->OldValue) ?>">
</td>
